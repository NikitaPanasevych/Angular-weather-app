...
describe('CityWeatherPageComponent', () => {
  ...
  let mockForecastService: jasmine.SpyObj<WeatherForecastService>;

  beforeEach(() => {
    mockActivatedRoute = {
      params: of({ city: 'Warsaw' }),
    };

    mockForecastService = jasmine.createSpyObj('WeatherForecastService', [
      'getWeather',
    ]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: WeatherForecastService, useValue: mockForecastService },
      ],
    }).compileComponents();
  ...
  it('should fetch weather forecast data for the specified city', () => {
    ...
    // Configure the forecastService spy to return the mockWeatherData
    mockForecastService.getWeather.and.returnValue(of(mockWeatherData));

    fixture.detectChanges(); // Trigger ngOnInit

    expect(mockForecastService.getWeather).toHaveBeenCalledWith('Warsaw');
    expect(component.cityForecastData).toEqual(mockWeatherData);
  });
});
